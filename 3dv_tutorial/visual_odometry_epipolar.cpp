...
int main(void)
{
    ...
    //double camera_focal = 520;
    //cv::Point2d camera_center(318.643040, 255.313989);
    double camera_focal = 270;
    cv::Point2d camera_center(270, 270);
    //double camera_focal = 448;
    //cv::Point2d camera_center(320, 240);
    //double camera_focal = 448;
    //cv::Point2d camera_center(960, 540);//1920 1080
    //double camera_focal = 448;
    //cv::Point2d camera_center(640, 512);
    //double camera_focal = 487.109;
    //cv::Point2d camera_center(320.788, 245.845);
